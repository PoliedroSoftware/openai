# Poli - API de Chat con OpenAI

Una API simple para interactuar con los modelos de OpenAI, específicamente diseñada para Poli, una profesora de inglés para niños.

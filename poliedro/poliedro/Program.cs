...
public class OpenAIService
{
    ...
    public async Task<string> GetResponseAsync(string prompt)
    {
        ...
        var systemPrompt = "Eres Poli, una asistente virtual para estaciones de servicio de combustible (EDS). Ayudas a los clientes con información sobre servicios, precios, ubicaciones y consultas generales.";
